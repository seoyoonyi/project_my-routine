...
const Main = () => {
  ...
  const filtereRoutine = useMemo(() => {
    ...
    const doneList = routineContextList.filter(
      (it: IRoutine) => it.activeStatus === "DONE"
    );
  ...
  return (
    <>
      ...
      <MainContainer>
        ...
        {filtereRoutine.doList?.length > 0 && <p>DO</p>}
        ...
        {filtereRoutine.doneList?.length > 0 && <p>DONE</p>}
