			...
			<div className="flex items-center justify-between h-8">
				<div className="flex items-center">
					<div className="flex mr-6 border rounded-md w-14 h-7">
						<Btn
							className="flex items-center justify-center w-1/2 h-full p-0 border-0 hover:bg-gray-100"
					...
					<div className="flex items-center">
						<h2 className="mr-1 text-xl">2022 12월</h2>
				...
				<div className="flex items-center justify-between h-full">
					{onWeek && (
						<Btn
							size="small"
							type="dashed"
							className="flex items-center mr-4 rounded-md"
							onClick={weekToggle}
						>
